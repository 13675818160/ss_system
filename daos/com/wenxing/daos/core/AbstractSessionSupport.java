...
import static com.wenxing.commons.helper.LoggerHelper.debug;
import static com.wenxing.commons.helper.LoggerHelper.isDebugEnabled;
...
import com.wenxing.daos.core.generator.SQLGenerator;
import com.wenxing.daos.core.impl.NameQueryImpl;
import com.wenxing.daos.core.impl.QueryImpl;
import com.wenxing.daos.core.mapper.ArrayMapper;
import com.wenxing.daos.core.setter.BatchPreparedStatementSetterImpl;
...
public abstract class AbstractSessionSupport extends
	 ...
	 * @see com.wenxing.daos.core.Query & cn.ycsoft.core.QueryImpl
	 * @param sql SQL命令
	 * @param params 对应的参数值
	 * @return 查询接口
	 * @throws Exception
	 ...
	 * @see com.wenxing.daos.core.Query & cn.ycsoft.core.SQLQueryImpl
	 * @param sql SQL命令
	 * @param params 对应的参数值
	 * @return 查询接口
	 * @throws Exception
