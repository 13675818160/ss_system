 ...
 * 进行更深度的封装。</p>
 * @see com.wenxing.daos.core.Session
...
public  class AbstractSessionImpl extends AbstractSessionSupport {
	...
	/**
	 * 按给定的sql命了及对应的参数查询，
	 * 将结果及封装至Map中(字段名作为KEY,字段值作为value)，并添加至List返回
	 * @param sql 参数使用 ?  代替
	 * @throws JDBCException
	 */
